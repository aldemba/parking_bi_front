...
const routes: Routes = [
  ...
  {path:'admin', loadChildren: ()=> import('./proprietaire/proprietaire.module').then(m=>m.ProprietaireModule),canActivate:[authGuard,roleGuard], data: { role: "ROLE_PROPRIETAIRE"}},
